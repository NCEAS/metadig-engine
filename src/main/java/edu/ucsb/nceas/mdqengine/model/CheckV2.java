 ...
 * 
 * CheckV2 is the representation of the MDQEngine 1.2 schema, which adds an
 * optional Expression element to the Selector, giving more flexibility than the
 * previously used, but still supported, xpath element.
 */
