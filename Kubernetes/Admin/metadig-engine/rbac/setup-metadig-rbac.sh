...
kubectl create -f role-metadig.yaml 
...
kubectl config set-credentials metadig --client-certificate=/home/slaughter/.certs/metadig.crt  --client-key=/home/slaughter/.certs/metadig.key
